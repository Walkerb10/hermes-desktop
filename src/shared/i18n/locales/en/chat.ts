export default {
  ...
  reasoningEffort: {
    ...
    auto: "Auto",
    autoDescription: "Let BHVA and the model decide.",
  ...
  deny: "Deny",
  clarify: {
    defaultQuestion: "BHVA needs your input.",
    placeholder: "Type your answer…  (Ctrl+Enter to send)",
    send: "Send",
    skip: "Skip — let BHVA decide",
    skipped: "Skipped — BHVA decided",

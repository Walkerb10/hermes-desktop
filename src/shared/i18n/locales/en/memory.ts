export default {
  title: "Memory",
  subtitle:
    "What BHVA remembers about you and your environment across sessions.",
  sessions: "Sessions",
  messages: "Messages",
  memories: "Memories",
  ...
  noMemoriesYet:
    "No memories yet. BHVA will save important facts as you chat.",
  ...
  userProfileHint:
    "Tell BHVA about yourself — name, role, preferences, communication style.",
  providersHint:
    "Pluggable memory providers give BHVA advanced long-term memory. Built-in memory (above) is always active alongside the selected provider.",

export default {
  ...
  dividerOr: "or",
  connectRemote: "Connect to Remote BHVA",
  connectRemoteTitle: "Connect to Remote BHVA",
  connectRemoteSubtitle: "Enter the URL of a running BHVA API server.",

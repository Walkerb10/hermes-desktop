export default {
  ...
  analytics: {
    ...
    hint: "Helps improve BHVA One by sending anonymous, aggregated usage data to the project's PostHog instance. You can turn this off at any time.",
    disclosure: {
  ...
  updateSuccess: "BHVA updated successfully.",
  ...
  poolHint:
    "Add multiple API Keys for the same provider for automatic rotation and load balancing. BHVA will cycle through them.",
  add: "Add",
  remove: "Remove",
  keyLabel: "Key",
  empty: "(empty)",
  dataSection: "Data",
  dataHint:
    "Export or import your BHVA configuration, sessions, skills, and memory.",
  ...
  migrationDesc:
    "Found OpenClaw at <code>{{path}}</code>. You can migrate your configuration, API keys, sessions, and skills to BHVA.",
  migrationDismiss: "Don't show again",
  migrating: "Migrating...",
  migrateToHermes: "Migrate to BHVA",
  skip: "Skip",
  ...
  modeLocal: "Local",
  modeRemote: "Remote",
  modeLocalHint: "Using BHVA installed on this device",
  modeRemoteHint: "Connect to a BHVA API server on your network or cloud",
  remoteUrl: "Remote URL",
  remoteUrlHint:
    "The BHVA API server URL (must expose /health and /v1/chat/completions)",
  ...
  serverConfigHint:
    "You&apos;re connected to a remote BHVA server. Model selection, provider API keys, and credentials are managed on the server&apos;s <code>~/.hermes/.env</code> and <code>config.yaml</code>. Edit them on the host (e.g. <code>docker exec -it hermes vi /opt/data/.env</code>) and restart the container.",
  connectionMode: "Mode",
  switchedToLocal: "Switched to local mode",

  // Community
  communityTitle: "Community",
  communityHint: "Join our Discord channel to ask questions, report issues, and chat with other BHVA users.",
  joinDiscord: "Join Discord Channel",

  // SSH & Server Config
  modeSsh: "SSH Tunnel",
  modeSshHint: "Tunnel to a remote BHVA over SSH — no exposed ports or API keys needed.",
  ...
  remoteEnvDesc: "Remote mode: add API_SERVER_KEY=<your-key> to the .env on your remote BHVA server, then restart the gateway.",
  sshHost: "SSH Host",
  sshPort: "SSH Port",
  sshUsername: "Username",
  sshKeyPath: "Private Key Path",
  sshKeyPathOptional: "(optional, defaults to ~/.ssh/id_rsa)",
  sshRemotePort: "Remote BHVA Port",
  ...
  sshSubtitle: "Tunnel to a remote BHVA over SSH — no exposed ports or API keys needed.",
  ...
  sshErrorConnection: "Could not connect via SSH or reach BHVA on the remote. Make sure:\n• SSH key is correct (or default ~/.ssh/id_rsa works)\n• BHVA gateway is running on the remote\n• The remote port is correct (default 8642)",
